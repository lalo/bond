...
tests = testGroup "Compiler tests"
    [ testGroup "AST"
        ...
        , testGroup "Compare .bond and swagger.json"
            [ testCase "attributes" $ compareSwag "attributes"
            , testCase "basic types" $ compareSwag "basic_types"
            , testCase "bond_meta types" $ compareSwag "bond_meta"
            , testCase "complex types" $ compareSwag "complex_types"
            , testCase "default values" $ compareSwag "defaults"
            , testCase "empty" $ compareSwag "empty"
            , testCase "field modifiers" $ compareSwag "field_modifiers"
            , testCase "generics" $ compareSwag "generics"
            , testCase "inheritance" $ compareSwag "inheritance"
            , testCase "type aliases" $ compareSwag "aliases"
            , testCase "documentation example" $ compareSwag "example"
            , testCase "simple service syntax" $ compareSwag "service"
            , testCase "service attributes" $ compareSwag "service_attributes"
            , testCase "generic service" $ compareSwag "generic_service"
            , testCase "documentation example" $ compareSwag "example"
            ]
        ]
    , testGroup "SchemaDef"
